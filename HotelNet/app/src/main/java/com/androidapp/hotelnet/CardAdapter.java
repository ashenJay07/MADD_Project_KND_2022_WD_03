...
public class CardAdapter extends RecyclerView.Adapter<CardAdapter.MyViewHolder> {
    ...
    public CardAdapter(Context context, List<String> name_id, List<String> email_id, List<String> age_id) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            itemView.findViewById(R.id.selectCardBtn).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {

                    Intent i = new Intent(v.getContext(), CardPaymentActivity.class);
